...
3.2. Заборонено:
• створювати заходи з метою шахрайства або реклами сторонніх сервісів
...
5.1. Відгуки можна залишати лише учасникам одного заходу.
...
7.1. Геолокація використовується лише для показу заходів поруч і не передається третім особам.
